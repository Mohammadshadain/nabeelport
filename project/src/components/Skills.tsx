        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
          {skillCategories.map((category, categoryIndex) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-lg p-4 sm:p-6 border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300"
            >
                ...
                {category.skills.map((skill, skillIndex) => (
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-orange-400 font-bold text-sm sm:text-base">{skill.level}%</span>
                    </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              <motion.div
                ...
                className="text-center p-4 sm:p-6 bg-gradient-to-br from-orange-500/10 to-red-500/10 rounded-lg border border-orange-500/20"
              >
                <motion.h4
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                  ...
                  viewport={{ once: true }}
                  className="text-2xl sm:text-3xl md:text-4xl font-bold text-orange-400 mb-2"
                >
                  {stat.number}
                </motion.h4>
